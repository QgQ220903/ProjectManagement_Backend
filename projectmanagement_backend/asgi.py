...
import task.routing
import file_detail.routing
import role_detail.routing
import account.routing
# Gộp tất cả WebSocket routes
websocket_urlpatterns = employee.routing.websocket_urlpatterns + message.routing.websocket_urlpatterns+ department.routing.websocket_urlpatterns + project.routing.websocket_urlpatterns + project_part.routing.websocket_urlpatterns +task_assignment.routing.websocket_urlpatterns+task.routing.websocket_urlpatterns + file_detail.routing.websocket_urlpatterns+ role_detail.routing.websocket_urlpatterns+ account.routing.websocket_urlpatterns
